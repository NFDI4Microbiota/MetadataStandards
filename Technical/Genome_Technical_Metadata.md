...
| trnas | Total number of tRNAs identified | MIMAG_v5[^4], SeqCode[^5][^21] |
| trna_ext_software | Tools used for tRNA identification | MIMAG_v5[^4], SeqCode[^5][^21] |
| compl_score | Completeness score | MIMAG_v5[^4], SeqCode[^5][^21] |
